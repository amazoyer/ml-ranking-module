...
@ContextConfiguration(classes = { SparkJobs.class , LtrClient.class, ResourceLoadingUtils.class, DatafariUsageDao.class, SparkContextProviderImpl.class, SolrClientProviderImpl.class})
