...
public class ResourceLoadingUtilsTest extends AbstractTest {
	...
	public void testTrainingEntrySerialization() throws JsonGenerationException, JsonMappingException, IOException {
		File file = new File(folder.getRoot(), "testTrainingEntrySerialization.json");
		...
		TrainingEntry trainingEntryDeserialized = resourceLoadingUtils.getObjectMapper().readValue(file,
				TrainingEntry.class);
